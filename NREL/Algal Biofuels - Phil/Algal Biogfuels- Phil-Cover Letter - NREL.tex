...
%
\renewcommand*{\namefont}{\fontsize{15}{2}\mdseries\upshape}
\renewcommand*{\sectionfont}{\fontsize{14}{8}\mdseries\upshape}
\renewcommand*{\subsectionfont}{\fontsize{13}{5}\mdseries\upshape}
%
...
\begin{spacing}{1.2}
\color{dark-gray}{
Photosynthetic organisms will play a vital role in transitioning towards a sustainable economy and as a dedicated researcher with a strong practical and theoretical background, I am well equipped to work towards making this a reality. 
Through my time at Europe's flagship laboratory for life sciences (EMBL) and my theses I have honed my skills in genetically engineering  \textit{E. coli} as well as algae and cyanobacteria.%
These experiences and my time competing in iGEM, I have helped me develop an eye for detail and an ability to function both independently and in an interdisciplinary team. % 
These skills combined with a strong work ethic and a passion for bioenergy  would make me an excellent candidate for the National Bioenergy Center.
%		Thomas: What part of the NBC does he work in?
}
%
...
\cvitem{Achievements}{
\begin{itemize}  
		\item Produced high-quality genetic constructs in \textit{E. coli }and viral vector tools like recombinant AAV and lentivirus in HEK cells
		\item Established new protocols for the production of viral vector tools 
...
\cvitem{Topic}{\emph{Biochemical analysis of the Cas6-1 RNA endonuclease associated with the subtype I-D CRISPR-Cas system in Synechocystis sp. PCC 6803.}{\:\href{https://www.tandfonline.com/eprint/vmAQ3vjYGdZIZpIKQTIT/full}{\textcolor{blue}{\textit{(Publication)}}}}}
...
\begin{itemize}  
		...
		\item Analyzed crRNA processing both \textit{in vitro} with mutant Synechocystis Cas6 proteins expressed in \textit{E. coli} and \textit{in vitro} transcribed RNA and in Synechocystis culture with inducible artificial crRNA and mutant Cas6 proteins
