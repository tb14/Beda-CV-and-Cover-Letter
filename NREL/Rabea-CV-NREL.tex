...
\begin{spacing}{1.2}
\color{dark-gray}{
Microbes can help us transitioning towards a sustainable, circular economy and as a dedicated researcher with a strong practical and theoretical background, I am well equipped to work towards making this a reality. 
Through my time at Europe's fagship laboratory for life sciences (EMBL) and my theses I have honed my skills in genetically engineering \textit{E. coli }as well as algae and cyanobacteria. 
My time competing in iGEM meanwhile, has helped me develop an eye for detail and an ability to function both independently and in an interdisciplinary team. 
These skills combined with a strong work ethic and a passion for sustainability would make me an excellent candidate to support your efforts of finding and designing new biocatalysts.}
% 
...
\begin{itemize}  
		...
		\item Regularly performed basic molecular biology techniques to amplify DNA (e.g. chemical transformation and electroporation in \textit{E. coli}, streaking cells for single colonies, serial dilutions, DNA purifications and PCRs) 
		\item Implemented new protocols to produce viral vector tools (AAV and lentivirus) in aseptic environment and to quantify them via quanitative PCR or transduction
...
\cvitem{Achievements}{
\begin{itemize}  
		\item Further characterized Synechocystis CRISPR-Cas system by generating Synechocystis mutant strains via homologous recombination and conjugating them with plasmid DNA
		\item Analyzed cleavage capability of mutant Synechocystis Cas6-1 proteins purified from \textit{E. coli} and their cleavage capability of \textit{in vitro} transcribed RNA  
		\item Analyzed cleavage capability of inducible mutant Synechocystis Cas6-1 proteins in culture via RNA extraction and gel electrophoresis
...
\begin{itemize}  
		...
		\item Assembled genetic constructs in \textit{E. coli} using restricion enzyme based cloning methods
\end{itemize}}
%
% EDUCATION
\thispagestyle{titlepage}
