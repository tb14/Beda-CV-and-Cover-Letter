...
%
% JOB REQUIREMENTS
%	diverse DNA cloning methods, PCR-based DNA amplification, design of DNA expression cassettes, methods of DNA transformation, protein detection methodologies, standard microbiological practices, and sterile technique
%	metabolic engineering tools to integrate, evolve, and improve new pathways and new genes in engineered strains for bioconversion of waste plastic materials.

%Be able to work independently.

%Have demonstrated experience in metabolic engineering, synthetic biology, and strain and enzyme evolution.

\begin{spacing}{1.2}
\color{dark-gray}{
Plastic and microbes are everywhere - so why not use the latter to degrade the former? As a dedicated researcher with a strong practical and theoretical background, I am well equipped to work towards making this a reality. 
Through my time at Europe’s ?agship laboratory
for life sciences (EMBL) and my theses I have honed my skills in genetically engineering E. coli
as well as algae and cyanobacteria. 
My time competing in iGEM meanwhile, has helped me
develop an eye for detail and an ability to function both independently and in an interdisciplinary
team. 
These skills combined with a strong work ethic and a passion for sustainability would make me an excellent candidate to support the National Bioenergy Center in finding ways to biodegrade plastics.}
% 
...
\cvitem{Achievements}{
\begin{itemize}  
		\item Used recombineering techniques, \textit{in vivo} fragment joining and classical and  Gibson cloning to produce high-quality genetic constructs in \textit{E. coli }
		\item Regularly performed chemical transformation and electroporation in \textit{E. coli}, streaking cells for single colonies, serial dilutions, DNA purifications and modifications
		\item Produced viral vector tools in aseptic environment and quantified them via quanitative PCR
		\item Implemented new protocols for the production and quantification of viral vector tools 
		\item Automated calculations for experimental procedures using FileMaker database and Microsoft Excel
		\item Improved FileMaker database and accurately manage sample data 
...
\cvitem{Achievements}{
\begin{itemize}  
		\item Further characterized Synechocystis CRISPR-Cas system
		\item Successfully generated Synechocystis mutant strains via homologous recombination and transformed them with plasmid DNA via conjugation
		\item Analyzed purity of mutant Synechocystis Cas6-1 proteins purified from \textit{E. coli} and their cleavage capability of \textit{in vitro} transcribed RNA via gel electrophoresis 
		\item Analyzed cleavage capability of mutant Synechocystis Cas6-1 proteins in culture via RNA extraction and gel electrophoresis
...
\begin{itemize}  
		...
		\item Accurately recorded and communicated results comprehensively for all team members, to a crowdfunding community and to a jury and fellow students at the final international conference at MIT
