...
During my time at Europe's flagship laboratory for the life sciences (EMBL) and my theses I have honed my skills in genetically engineering  \textit{E. coli} as well as algae and cyanobacteria.%
Through these experiences and my time competing in iGEM, I have developed a discerning eye for detail and an ability to function both independently and as part of an interdisciplinary team. % 
These experiences combined with a strong work ethic and a passion for bioenergy make me an excellent candidate for NREL's National Bioenergy Center.
